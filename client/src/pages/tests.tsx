                ...
                <Card key={test.id} className={`relative overflow-hidden bg-white/95 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md ${isSelected ? "border-blue-500 ring-2 ring-blue-100" : "border-slate-200/90"}`}>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <a href={`/api/tests/${encodeURIComponent(test.id)}/pdf`} className="inline-flex h-9 items-center justify-center rounded-md border border-rose-200 bg-rose-50 px-2 text-xs font-semibold text-rose-700 transition-colors hover:bg-rose-100" download>
