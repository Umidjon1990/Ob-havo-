      ...
      <DialogContent className="max-w-xs sm:max-w-md rounded-3xl bg-white/90 dark:bg-black/90 backdrop-blur-xl border-white/20">
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          ...
          >
            ...
            <span className="font-bold">12 km/s</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-xs text-muted-foreground">Bosim</span>
            <span className="font-bold">760 mm</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-xs text-muted-foreground">Hafta kuni</span>
            <span className="font-bold">Seshanba</span>
          </motion.div>
        </div>

        <div className="mt-4 p-4 bg-muted/50 rounded-2xl text-center">
            <p className="text-sm text-muted-foreground italic">
                "Bugun sayr qilish uchun ajoyib ob-havo!"
            </p>
        </div>
      </DialogContent>
    </Dialog>
